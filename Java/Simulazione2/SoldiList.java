...
public class SoldiList extends SoldiAstratto {
    /*
    si basa sulle LinkedList come collezione ordinata
     */
    public SoldiList() {
        super(new LinkedList<>());
    }

    public SoldiList(LinkedList<Denaro> list) {
        super(list);
    }
    ...
    public Soldi paga(Soldi s1, Soldi s2) {
        ...
        LinkedList<Denaro> ret = new LinkedList<>();
